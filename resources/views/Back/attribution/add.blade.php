        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              ...
              <a href="{{route('attribution.index')}}" class="btn btn-success" >Lister Les Attributions</a>
              <h2 ><center><strong>Ajouter une Attribution</strong></center></h2>
            </h5>
            </div>
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="exemleInputEmail">user</label>
