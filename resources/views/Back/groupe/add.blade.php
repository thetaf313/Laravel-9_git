        ...
        <div class="col-lg-12">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              ...
              <a href="{{route('groupe.index')}}" class="btn btn-success" >Lister Les Groupes</a>
              <h2 ><center><strong>Ajouter un groupe</strong></center></h2>
            </h5>
            </div>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nom_groupe" id="exampleInputEmail1" placeholder="Nom groupe">
              </div>
